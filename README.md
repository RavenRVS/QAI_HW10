...
## Задание 1. Радиоман (обязательное к выполнению) <a href="https://github.com/RavenRVS/QAI_HW9_T1/pull/1">(моё решение) </a>
...
## Задание 2*. Lombok (необязательная задача) <a href="https://github.com/RavenRVS/QAI_HW9_T1/pull/2">(моё решение) </a>
